    ...
    public function run()
    {
        DB::table('schools')->insert([
            [
                ...
                "address1" => '月島',
                "address2" => '1-1-1',
                'detail' => "「親に時間を、子供に冒険を」をコンセプトに、定額制の子供向けアクティビティサービス「Kidsweekend」をリリース。子供に沢山の体験をさせながら、親子の貴重な経験を増やしてほしいとの思いから、サービスを開始しました。\n\n通常の習い事とは異なる、未来を生き抜く子供に必要な思考力や主体性を育てるコンテンツを多数展開していきます！"
            ],
            [
