    ...
    public function run()
    {
        DB::table('activities')->insert([
            [
                ...
                "pub_state" => 0,
                "name" => 'プログラミングであそぼう',
                "detail" => "プログラミングって何だろう？というお子様向けのクラスです。世界180カ国で使われているプログラミング教材を使い、幼児からプログラミングの世界を楽しく体験することができます。ブロックを直感的に並べていくだけでプログラムを組むことができ、お子様でも簡単に操作できます。プログラミングの基礎を楽しく学びましょう！＊保護者の付き添いは特に必要ではありません。"
            ],
            [
